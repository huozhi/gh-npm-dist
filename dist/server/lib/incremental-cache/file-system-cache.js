...
class FileSystemCache {
    ...
    async get(key) {
        var ref;
        let data = (ref = this.memoryCache) === null || ref === void 0 ? void 0 : ref.get(key);
        ...
        if (!data) {
            try {
                ...
                (ref1 = this.memoryCache) === null || ref1 === void 0 ? void 0 : ref1.set(key, data);
            } catch (_) {
    ...
    async set(key, data) {
        ...
        (ref = this.memoryCache) === null || ref === void 0 ? void 0 : ref.set(key, {
            value: data,
            lastModified: Date.now()
        });
        if ((data === null || data === void 0 ? void 0 : data.kind) === 'PAGE') {
