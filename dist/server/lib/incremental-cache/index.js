...
class IncrementalCache {
    ...
    async get(pathname) {
        ...
        const curRevalidate = (ref = this.prerenderManifest.routes[toRoute(pathname)]) === null || ref === void 0 ? void 0 : ref.initialRevalidateSeconds;
        const revalidateAfter = this.calculateRevalidate(pathname, (cacheData === null || cacheData === void 0 ? void 0 : cacheData.lastModified) || Date.now());
