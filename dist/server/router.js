...
class Router {
    ...
    get locales() {
        var ref;
        return ((ref = this.nextConfig.i18n) === null || ref === void 0 ? void 0 : ref.locales) || [];
    }
    get basePath() {
    ...
    async execute(req, res, parsedUrl) {
      ...
      */ const [edgeSSRCatchAllRoute, middlewareCatchAllRoute] = this.catchAllMiddleware;
            ...
            for (const testRoute of allRoutes){
                ...
                if (!testRoute.matchesLocale && pathnameInfo.locale === ((ref = this.nextConfig.i18n) === null || ref === void 0 ? void 0 : ref.defaultLocale) && pathnameInfo.locale) {
