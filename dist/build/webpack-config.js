...
async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , hasReactRoot , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target ='server' , appDir , middlewareRegex  }) {
    ...
    const getBabelOrSwcLoader = ()=>{
        var ref;
        if (useSWCLoader && (config === null || config === void 0 ? void 0 : (ref = config.experimental) === null || ref === void 0 ? void 0 : ref.swcTraceProfiling)) {
            ...
            ref42, ref43;
            (ref42 = require('./swc')) === null || ref42 === void 0 ? void 0 : (ref43 = ref42.initCustomTraceSubscriber) === null || ref43 === void 0 ? void 0 : ref43.call(ref42, _path.default.join(distDir, `swc-trace-profile-${Date.now()}.json`));
        }
        return useSWCLoader ? {
    ...
    const rawPageExtensions = hasServerComponents ? (0, _utils1).withoutRSCExtensions(config.pageExtensions) : config.pageExtensions;
    ...
    const clientEntries = isClient ? {
        ...
        ...config.experimental.appDir ? {
            [_constants1.CLIENT_STATIC_FILES_RUNTIME_MAIN_ROOT]: `./` + _path.default.relative(dir, _path.default.join(_constants.NEXT_PROJECT_ROOT_DIST_CLIENT, 'app-next.js')).replace(/\\/g, '/')
        } : {}
    } : undefined;
    ...
    const looseEsmExternals = ((ref44 = config.experimental) === null || ref44 === void 0 ? void 0 : ref44.esmExternals) === 'loose';
    async function handleExternals(context, request, dependencyType, getResolve) {
        ...
        if (!isLocal) {
            ...
            const notExternalModules = /^(?:private-next-pages\/|next\/(?:dist\/pages\/|(?:app|document|link|image|constants|dynamic|script)$)|string-hash$)/;
    ...
    const rscSharedRegex = /(node_modules\/react\/|\/shared\/lib\/(head-manager-context|router-context)\.js|node_modules\/styled-jsx\/)/;
    let webpackConfig = {
                ...
                return {
                    ...
                    cacheGroups: {
                        framework: {
                            ...
                            test (module) {
                                var ref;
                                const resource = (ref = module.nameForCondition) === null || ref === void 0 ? void 0 : ref.call(module);
                                return resource ? topLevelFrameworkPaths.some((pkgPath)=>resource.startsWith(pkgPath)
                                ) : false;
                            },
                            priority: 40,
                    ...
                    new TerserPlugin({
                        ...
                        terserOptions: {
                            ...
                            compress: {
                                ...
                                ...(ref46 = (ref = config.experimental.swcMinifyDebugOptions) === null || ref === void 0 ? void 0 : ref.compress) !== null && ref46 !== void 0 ? ref46 : {}
                            },
                            mangle: {
                                ...terserOptions.mangle,
                                ...(ref47 = (ref45 = config.experimental.swcMinifyDebugOptions) === null || ref45 === void 0 ? void 0 : ref45.mangle) !== null && ref47 !== void 0 ? ref47 : {}
                            }
                        }
                    }).apply(compiler);
                },
        ...
        plugins: [
            ...!dev && isEdgeServer && !!config.experimental.middlewareSourceMaps && !config.productionBrowserSourceMaps ? require('./webpack/plugins/middleware-source-maps-plugin').getMiddlewareSourceMapPlugins() : [],
            ...
            new _webpack.webpack.DefinePlugin({
                ...
                'process.env.__NEXT_MIDDLEWARE_REGEX': JSON.stringify(middlewareRegex || ''),
                ...
                'process.env.__NEXT_IMAGE_OPTS': JSON.stringify({
                    ...
                    experimentalUnoptimized: config === null || config === void 0 ? void 0 : (ref1 = config.experimental) === null || ref1 === void 0 ? void 0 : (ref2 = ref1.images) === null || ref2 === void 0 ? void 0 : ref2.unoptimized,
                    experimentalLayoutRaw: (ref3 = config.experimental) === null || ref3 === void 0 ? void 0 : (ref4 = ref3.images) === null || ref4 === void 0 ? void 0 : ref4.layoutRaw,
                    ...dev ? {
                        // pass domains in development to allow validating on the client
                        domains: config.images.domains,
                        experimentalRemotePatterns: (ref5 = config.experimental) === null || ref5 === void 0 ? void 0 : (ref6 = ref5.images) === null || ref6 === void 0 ? void 0 : ref6.remotePatterns
                    } : {}
                }),
                'process.env.__NEXT_ROUTER_BASEPATH': JSON.stringify(config.basePath),
                'process.env.__NEXT_HAS_REWRITES': JSON.stringify(hasRewrites),
                'process.env.__NEXT_I18N_SUPPORT': JSON.stringify(!!config.i18n),
                'process.env.__NEXT_I18N_DOMAINS': JSON.stringify((ref7 = config.i18n) === null || ref7 === void 0 ? void 0 : ref7.domains),
          ...
          `
            ...
            }) : new _clientEntryPlugin.ClientEntryPlugin({
                dev,
                isEdgeServer
            })),
            !dev && isClient && new (require('./webpack/plugins/telemetry-plugin')).TelemetryPlugin(new Map([
                ...
                [
                    'swcRelay',
                    !!((ref8 = config.compiler) === null || ref8 === void 0 ? void 0 : ref8.relay)
                ],
                [
                    'swcStyledComponents',
                    !!((ref9 = config.compiler) === null || ref9 === void 0 ? void 0 : ref9.styledComponents)
                ],
                [
                    'swcReactRemoveProperties',
                    !!((ref10 = config.compiler) === null || ref10 === void 0 ? void 0 : ref10.reactRemoveProperties), 
                ],
                [
                    'swcExperimentalDecorators',
                    !!(jsConfig === null || jsConfig === void 0 ? void 0 : (ref11 = jsConfig.compilerOptions) === null || ref11 === void 0 ? void 0 : ref11.experimentalDecorators), 
                ],
                [
                    'swcRemoveConsole',
                    !!((ref12 = config.compiler) === null || ref12 === void 0 ? void 0 : ref12.removeConsole)
                ],
                [
                    'swcImportSource',
                    !!(jsConfig === null || jsConfig === void 0 ? void 0 : (ref13 = jsConfig.compilerOptions) === null || ref13 === void 0 ? void 0 : ref13.jsxImportSource)
                ],
                [
                    'swcEmotion',
                    !!((ref14 = config.compiler) === null || ref14 === void 0 ? void 0 : ref14.emotion)
                ],
                SWCBinaryTarget, 
            ].filter(Boolean))), 
        ].filter(Boolean)
    ...
    if (typeof config.webpack === 'function') {
        ...
        if (((ref34 = webpack5Config.experiments) === null || ref34 === void 0 ? void 0 : ref34.lazyCompilation) === true) {
            webpack5Config.experiments.lazyCompilation = {
                entries: false
            };
        } else if (typeof ((ref35 = webpack5Config.experiments) === null || ref35 === void 0 ? void 0 : ref35.lazyCompilation) === 'object' && webpack5Config.experiments.lazyCompilation.entries !== false) {
    ...
    if (!config.images.disableStaticImages) {
        var ref36;
        const rules = ((ref36 = webpackConfig.module) === null || ref36 === void 0 ? void 0 : ref36.rules) || [];
    ...
    if (hasUserCssConfig) {
        ...
        if ((ref38 = webpackConfig.module) === null || ref38 === void 0 ? void 0 : ref38.rules.length) {
        ...
        if ((ref39 = webpackConfig.plugins) === null || ref39 === void 0 ? void 0 : ref39.length) {
            // Disable CSS Extraction Plugin
            webpackConfig.plugins = webpackConfig.plugins.filter((p)=>p.__next_css_remove !== true
            );
        }
        if ((ref40 = webpackConfig.optimization) === null || ref40 === void 0 ? void 0 : (ref41 = ref40.minimizer) === null || ref41 === void 0 ? void 0 : ref41.length) {
