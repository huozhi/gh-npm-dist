...
function nextTransformSsg({ types: t  }) {
    ...
    function markFunction(path, state) {
        ...
        if ((ident === null || ident === void 0 ? void 0 : ident.node) && isIdentifierReferenced(ident)) {
            ...
            Program: {
                enter (path, state) {
                            ...
                            if (variablePath.node.id.type === 'Identifier') {
                                ...
                                elements.forEach((e)=>{
                                    ...
                                    if (((ref = e.node) === null || ref === void 0 ? void 0 : ref.type) === 'Identifier') {
                                        local = e;
                                    } else if (((ref1 = e.node) === null || ref1 === void 0 ? void 0 : ref1.type) === 'RestElement') {
                    ...
                    function sweepFunction(sweepPath) {
                        ...
                        if ((ident === null || ident === void 0 ? void 0 : ident.node) && refs.has(ident) && !isIdentifierReferenced(ident)) {
                            ++count;
