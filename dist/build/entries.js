...
function getEdgeServerEntry(opts) {
    if ((0, _utils1).isMiddlewareFile(opts.page)) {
        ...
        const loaderParams = {
            ...
            page: opts.page,
            matcherRegexp: ((ref = opts.middleware) === null || ref === void 0 ? void 0 : ref.pathMatcher) && opts.middleware.pathMatcher.source
        };
            ...
            runDependingOnPageType({
                ...
                onEdgeServer: ()=>{
                    edgeServer[serverBundlePath] = getEdgeServerEntry({
                        ...
                        isServerComponent,
                        page,
                        middleware: staticInfo === null || staticInfo === void 0 ? void 0 : staticInfo.middleware
                    });
                }
            });
        };
...
function finalizeEntrypoint({ name , compilerType , value , isServerComponent , appDir  }) {
    ...
    if (compilerType === 'edge-server') {
        return {
            layer: (0, _utils1).isMiddlewareFilename(name) ? 'middleware' : undefined,
            library: {
                name: [
                    '_ENTRIES',
                    `middleware_[name]`
