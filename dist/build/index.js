...
var _clientEntryPlugin = require("./webpack/plugins/client-entry-plugin");
        ...
        const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            if (!ignoreTypeScriptErrors && verifyResult) {
                ...
                telemetry.record((0, _events).eventTypeCheckCompleted({
                    ...
                    inputFilesCount: (ref3 = verifyResult.result) === null || ref3 === void 0 ? void 0 : ref3.inputFilesCount,
                    totalFilesCount: (ref4 = verifyResult.result) === null || ref4 === void 0 ? void 0 : ref4.totalFilesCount,
                    incremental: (ref5 = verifyResult.result) === null || ref5 === void 0 ? void 0 : ref5.incremental
                }));
            }
            ...
            const pagePaths = await nextBuildSpan.traceChild('collect-pages').traceAsyncFn(()=>(0, _recursiveReaddir).recursiveReadDir(pagesDir, new RegExp(`\\.(?:${config.pageExtensions.join('|')})$`))
            );
            let appPaths;
            if (appDir) {
            ...
            let mappedappPaths;
            if (appPaths && appDir) {
                mappedappPaths = nextBuildSpan.traceChild('create-app-mapping').traceFn(()=>(0, _entries).createPagesMapping({
                        pagePaths: appPaths,
                        hasServerComponents,
                        isDev: false,
                        pagesType: 'app',
            ...
            const hasPages404 = (ref9 = mappedPages['/404']) === null || ref9 === void 0 ? void 0 : ref9.startsWith(_constants.PAGES_DIR_ALIAS);
            const hasCustomErrorPage = mappedPages['/_error'].startsWith(_constants.PAGES_DIR_ALIAS);
            if (Object.keys(mappedRootPaths || {}).some(_utils2.isMiddlewareFile)) {
            ...
            const routesManifest = nextBuildSpan.traceChild('generate-routes-manifest').traceFn(()=>({
                    ...
                    dynamicRoutes: (0, _utils).getSortedRoutes(pageKeys).filter(_utils.isDynamicRoute).map(pageToRoute),
                    staticRoutes: (0, _utils).getSortedRoutes(pageKeys).filter((page)=>!(0, _utils).isDynamicRoute(page) && !(0, _utils2).isReservedPage(page)
                    ).map(pageToRoute),
                    dataRoutes: [],
            ...
            await (async ()=>{
                ...
                await runWebpackSpan.traceAsyncFn(async ()=>{
                    ...
                    if (isLikeServerless) {
                        ...
                        _clientEntryPlugin.injectedClientEntries.clear();
                        serverResult = await (0, _compiler).runCompiler(configs[1], {
                            runWebpackSpan
                        });
                        edgeServerResult = configs[2] ? await (0, _compiler).runCompiler(configs[2], {
                        ...
                        // Only continue if there were no errors
                        if (!serverResult.errors.length && !(edgeServerResult === null || edgeServerResult === void 0 ? void 0 : edgeServerResult.errors.length)) {
                            _clientEntryPlugin.injectedClientEntries.forEach((value, key)=>{
                    ...
                    result = {
                        warnings: [].concat(clientResult === null || clientResult === void 0 ? void 0 : clientResult.warnings, serverResult === null || serverResult === void 0 ? void 0 : serverResult.warnings, edgeServerResult === null || edgeServerResult === void 0 ? void 0 : edgeServerResult.warnings).filter(_nonNullable.nonNullable),
                        errors: [].concat(clientResult === null || clientResult === void 0 ? void 0 : clientResult.errors, serverResult === null || serverResult === void 0 ? void 0 : serverResult.errors, edgeServerResult === null || edgeServerResult === void 0 ? void 0 : edgeServerResult.errors).filter(_nonNullable.nonNullable),
                        stats: [
                            clientResult === null || clientResult === void 0 ? void 0 : clientResult.stats,
                            serverResult === null || serverResult === void 0 ? void 0 : serverResult.stats,
                            edgeServerResult === null || edgeServerResult === void 0 ? void 0 : edgeServerResult.stats, 
                        ]
                    };
                });
            ...
            if (result.errors.length > 0) {
                ...
                console.error();
                var _errors;
                const edgeRuntimeErrors = (_errors = (ref6 = result.stats[2]) === null || ref6 === void 0 ? void 0 : ref6.compilation.errors) !== null && _errors !== void 0 ? _errors : [];
                for (const err of edgeRuntimeErrors){
                    // When using the web runtime, common Node.js native APIs are not available.
                    const moduleName = (0, _utils2).getUnresolvedModuleFromError(err.message);
                    if (!moduleName) continue;
                    const e = new Error((0, _utils2).getNodeBuiltinModuleNotSupportedInEdgeRuntimeMessage(moduleName));
                ...
                const err1 = new Error('Build failed because of webpack errors');
                err1.code = 'WEBPACK_ERRORS';
                throw err1;
            } else {
            ...
            const { customAppGetInitialProps , namedExports , isNextImageImported: isNextImageImported1 , hasSsrAmpPages: hasSsrAmpPages1 , hasNonStaticErrorPage ,  } = await staticCheckSpan.traceAsyncFn(async ()=>{
                ...
                const errorPageStaticResult = nonStaticErrorPageSpan.traceAsyncFn(async ()=>{
                    var ref, ref10;
                    return hasCustomErrorPage && staticWorkers.isPageStatic('/_error', distDir, isLikeServerless, configFileName, runtimeEnvConfig, config.httpAgentOptions, (ref = config.i18n) === null || ref === void 0 ? void 0 : ref.locales, (ref10 = config.i18n) === null || ref10 === void 0 ? void 0 : ref10.defaultLocale);
                });
                ...
                await Promise.all(pageKeys.map(async (page)=>{
                    ...
                    return checkPageSpan.traceAsyncFn(async ()=>{
                        ...
                        const pageRuntime = pagePath ? (await (0, _getPageStaticInfo).getPageStaticInfo({
                        ...
                        if (!(0, _utils2).isReservedPage(page) && // We currently don't support static optimization in the Edge runtime.
                        pageRuntime !== 'edge') {
                            try {
                                let isPageStaticSpan = checkPageSpan.traceChild('is-page-static');
                                let workerResult = await isPageStaticSpan.traceAsyncFn(()=>{
                                    var ref, ref11;
                                    return staticWorkers.isPageStatic(page, distDir, isLikeServerless, configFileName, runtimeEnvConfig, config.httpAgentOptions, (ref = config.i18n) === null || ref === void 0 ? void 0 : ref.locales, (ref11 = config.i18n) === null || ref11 === void 0 ? void 0 : ref11.defaultLocale, isPageStaticSpan.id);
                                });
            ...
            telemetry.record((0, _events).eventBuildOptimize(pagePaths, {
                ...
                hasReportWebVitals: (ref7 = namedExports === null || namedExports === void 0 ? void 0 : namedExports.includes('reportWebVitals')) !== null && ref7 !== void 0 ? ref7 : false,
            ...
            if (ssgPages.size > 0) {
                ...
                await generateClientSsgManifest(prerenderManifest, {
                    distDir,
                    buildId,
                    locales: ((ref8 = config.i18n) === null || ref8 === void 0 ? void 0 : ref8.locales) || []
                });
            } else {
                const prerenderManifest = {
                    version: 3,
            ...
            var _pathname;
            images.remotePatterns = ((config === null || config === void 0 ? void 0 : (ref1 = config.experimental) === null || ref1 === void 0 ? void 0 : (ref2 = ref1.images) === null || ref2 === void 0 ? void 0 : ref2.remotePatterns) || []).map((p)=>({
                    // Should be the same as matchRemotePattern()
                    protocol: p.protocol,
                    hostname: (0, _micromatch).makeRe(p.hostname).source,
                    port: p.port,
                    pathname: (0, _micromatch).makeRe((_pathname = p.pathname) !== null && _pathname !== void 0 ? _pathname : '**').source
                })
            );
 ...
 */ function verifyTypeScriptSetup(dir, intentDirs, typeCheckPreflight, tsconfigPath, disableStaticImages, cacheDir, numWorkers, enableWorkerThreads) {
    ...
    return typeCheckWorker.verifyTypeScriptSetup(dir, intentDirs, typeCheckPreflight, tsconfigPath, disableStaticImages, cacheDir).then((result)=>{
        typeCheckWorker.end();
        return result;
    });
}
